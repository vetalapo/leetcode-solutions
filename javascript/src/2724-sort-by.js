 ...
 *   Output: [1, 2, 3, 4, 5]
 *   Explanation:
 *     fn simply returns the number passed to it
 *     so the array is sorted in ascending order.
 *
 * Example 2:
 *   Input: arr = [{"x": 1}, {"x": 0}, {"x": -1}], fn = (d) => d.x
 *   Output: [{"x": -1}, {"x": 0}, {"x": 1}]
 *   Explanation:
 *     fn returns the value for the "x" key.
 *     So the array is sorted based on that value.
 *
 * Example 3:
