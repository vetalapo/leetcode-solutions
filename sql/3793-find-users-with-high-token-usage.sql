 ...
 *
 * Write a solution to analyze AI prompt usage patterns
 ...
 *   • Only include users who have submitted at least one prompt
 *     with tokens greater than their own average token usage.
 *
