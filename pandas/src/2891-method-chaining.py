...
#   +-------------+--------+
#
# Write a solution to list the names of animals
# that weigh strictly more than 100 kilograms.
#
...
#     Jonathan's weight is 463,
#     Tommy's weight is 349, and
#     Alex's weight is 328.
#     The results should be sorted in descending order of weight.
#
# In Pandas,
# method chaining enables us to perform operations on a DataFrame
