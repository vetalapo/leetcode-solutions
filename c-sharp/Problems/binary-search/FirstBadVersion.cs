...
public class FirstBadVersionSolution( int badVersion ) : VersionControl( badVersion )
{
...
public class VersionControl( int badVersion )
{
    private readonly int _badVersion = badVersion;

    public bool IsBadVersion( int n )
    {
        return this._badVersion == n;
    }
}
