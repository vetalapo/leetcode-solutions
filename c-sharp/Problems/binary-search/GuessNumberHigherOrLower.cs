...
public class GuessNumberHigherOrLower( int num ) : GuessGame( num )
{
...
public class GuessGame( int num )
{
    private readonly int _secretNum = num;

    public int guess( int num )
    {
        if ( num == this._secretNum )
        {
            return 0;
        }
        else if ( num < this._secretNum )
        {
            return 1;
        }
