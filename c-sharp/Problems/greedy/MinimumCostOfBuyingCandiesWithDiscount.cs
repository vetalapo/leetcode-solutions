 ...
 *
 * The customer can choose any candy to take away for free
 * as long as the cost of the chosen candy
 ...
 *   they can take the candy with cost 1 for free,
 ...
 *
 * Hint 1:
 *   If we consider costs from high to low,
 *   what is the maximum cost of a single candy that we can get for free?
 *
 * Hint 2:
...
public class MinimumCostOfBuyingCandiesWithDiscount
{
    public int MinimumCost( int[] cost )
    {
        ...
        for ( int i = countMap.Length - 1, j = 0; i > 0; i-- )
        {
            while ( countMap[i] > 0 )
            {
                j++;
