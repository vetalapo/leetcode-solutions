 ...
 *
 * Your task is to find two indices i and j,
 ...
 * where answer = [i, j] if there are two such indices,
 ...
 *     In this example,
 *     it can be shown
 *     that it is impossible to find two indices
 ...
 *
 * Hint 2:
 *   You can use a nested loop to compare each pair of indices (i, j)
