 ...
 *
 * Hint 1:
 *   We can sequentially check
 *   if “999”, “888”, “777”, … , “000” exists in num in that order.
 *   The first to be found is the maximum good integer.
 *
 * Hint 2:
 *   If we cannot find any of the above integers,
...
public class Largest3SameDigitNumberInString
{
    public string LargestGoodInteger( string num )
    {
        ...
        {
            if ( num[i] > max && num[i] == num[i - 1] && num[i] == num[i - 2] )
            {
                max = num[i];
            }
        }
