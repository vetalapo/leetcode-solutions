 ...
 * should form the second row of the constructed 2D array,
 * and so on.
 *
 * Return an m x n 2D array
 * constructed according to the above procedure,
 ...
 *     The first group of n=2 elements in original,
 *     [1,2], becomes the first row in the constructed 2D array.
 ...
 *     Put all three elements in original
 *     into the first row of the constructed 2D array.
 *
 * Example 3:
 ...
 *
 * Hint 1:
 *   When is it possible to convert original
 *   into a 2D array and when is it impossible?
 *
 * Hint 2:
 ...
 *   keep an index i such that original[i]
 *   is the next element to add to the 2D array.
 **
