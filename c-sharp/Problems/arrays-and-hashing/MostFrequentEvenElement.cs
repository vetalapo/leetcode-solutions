 ...
 *   Output: 2
 *   Explanation:
 *     The even elements are 0, 2, and 4.
 *     Of these, 2 and 4 appear the most.
...
public class MostFrequentEvenElement
{
    public int MostFrequentEven( int[] nums )
    {
        ...
        foreach ( (int element, int count) in countMap )
        {
            if ( count == maxCount )
            {
                if ( maxEvenElement > element )
                {
                    maxEvenElement = element;
                }
            }
