 ...
 * such that it is strictly greater
 * than the average of all elements in nums.
 *
 * The average of an array is defined
 * as the sum of all its elements
 ...
 *
 * Hint 1:
 *   Compute the average, set x = floor(avg) + 1
 *   (the smallest integer greater than the average).
 *
 * Hint 2:
 *   Increment x until it's not in the array and return it.
 **
