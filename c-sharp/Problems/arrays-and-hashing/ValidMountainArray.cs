 ...
 *   a monotonically increasing or decreasing ordering of elements.
 *   You just need to be able to determine
 *   the start of the valley in the mountain and from that point onwards,
 *   it should be a valley i.e. no mini-hills after that.
 *   Use this information in regards to the values in the array
...
public class ValidMountainArraySolution
{
    public bool ValidMountainArray( int[] arr )
    {
        ...
        {
            if ( arr[i - 1] == arr[i] || ( peak && arr[i - 1] < arr[i] ) )
            {
                return false;
            }
