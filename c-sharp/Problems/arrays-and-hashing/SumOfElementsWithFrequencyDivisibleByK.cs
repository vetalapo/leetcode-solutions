 ...
 * whose frequency is divisible by k,
 * or 0 if there are no such elements.
 *
 * Note:
 *   An element is included in the sum exactly as many times
 ...
 *   Output: 0
 *   Explanation:
 *     There are no elements that appear an even number of times,
