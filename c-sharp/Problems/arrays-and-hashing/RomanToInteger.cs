...
{
    private static readonly int[] RomanValuesMap = new int[89];
    ...
    static RomanToInteger()
    {
        ...
        RomanValuesMap['X'] = 10;
        RomanValuesMap['L'] = 50;
        RomanValuesMap['C'] = 100;
        RomanValuesMap['D'] = 500;
        RomanValuesMap['M'] = 1000;
    }

    public int RomanToInt( ReadOnlySpan<char> s )
    {
        int result = 0;
        int prev = 0;
