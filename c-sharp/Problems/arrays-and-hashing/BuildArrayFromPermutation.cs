 ...
 *   since some elements will change after application
 **
...
public class BuildArrayFromPermutation
{
    public int[] BuildArray( int[] nums )
    {
        ...
        {
            // Add secondary values onto original values as multiples of the length of the array
            // modulus means original value
