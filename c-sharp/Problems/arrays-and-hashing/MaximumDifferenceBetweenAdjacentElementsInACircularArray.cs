 ...
 *   Output: 3
 *   Explanation:
 *     Because nums is circular,
 *     nums[0] and nums[2] are adjacent.
 ...
 *   Output: 5
 *   Explanation:
 *     The adjacent elements nums[0] and nums[1]
 ...
 *   and check the difference of every adjacent pair.
 *
 * Hint 2:
 *   The edge case is to check the difference between
