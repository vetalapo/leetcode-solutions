 ...
 *     with i = 1 and j = 2, nums[j] - nums[i] = 5 - 1 = 4.
 *     Note that with i = 1 and j = 0,
 *     the difference nums[j] - nums[i] = 7 - 1 = 6,
 ...
 *
 * Hint 2:
 *   We have a potential candidate for the answer
 *   if the prefix min is lesser than nums[i].
 **
