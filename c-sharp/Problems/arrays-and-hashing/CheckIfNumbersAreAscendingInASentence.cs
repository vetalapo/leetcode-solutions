 ...
 * Every token is either a positive number
 ...
 *
 * Hint 1:
 *   Use string tokenization of your language
 *   to extract all the tokens of the string easily.
 *
 * Hint 2:
 *   For each token extracted,
 *   how can you tell if it is a number?
 *   Does the first letter being a digit mean something?
 *
 * Hint 3:
 *   Compare the number with the previously occurring number
 *   to check if ascending order is maintained.
 **
