 ...
 * Specifically,
 * check if there are two subarrays starting at indices a and b (a < b),
 * where:
 *   • Both subarrays nums[a..a + k - 1] and nums[b..b + k - 1] are strictly increasing.
 *   • The subarrays must be adjacent, meaning b = a + k.
 *
 * Return true if it is possible to find two such subarrays,
 * and false otherwise.
 *
 * Example 1:
 ...
 *   Output: true
 *   Explanation:
 *     • The subarray starting at index 2 is [7, 8, 9],
 *       which is strictly increasing.
 *     • The subarray starting at index 5 is [2, 3, 4],
