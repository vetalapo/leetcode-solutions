 ...
 * where answer[0] is the number of pairs
 ...
 *     No more pairs can be formed.
 *     A total of 1 pair has been formed, and there are 0 numbers leftover in nums.
 *
 * Example 3:
 *   Input: nums = [0]
 *   Output: [0,1]
 ...
 *
 * Hint 1:
 *   What do we need to know to find how many pairs we can make?
 *   We need to know the frequency of each integer.
 *
 * Hint 2:
 *   When will there be a leftover number?
 *   When the frequency of an integer is an odd number.
 **
...
public class MaximumNumberOfPairsInArray
{
    public int[] NumberOfPairs( int[] nums )
    {
        ...
        return [pairsCount, nums.Length - pairsCount * 2];
    }
}
