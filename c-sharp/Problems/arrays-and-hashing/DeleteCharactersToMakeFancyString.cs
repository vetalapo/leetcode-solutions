 ...
 **
 * A fancy string is a string
 * where no three consecutive characters are equal.
 *
 * Given a string s,
 ...
 *
 * Hint 1:
 *   What's the optimal way to delete characters
 *   if three or more consecutive characters are equal?
 *
 * Hint 2:
 *   If three or more consecutive characters are equal,
...
public class DeleteCharactersToMakeFancyString
{
    public string MakeFancyString( string s )
    {
        ...
        StringBuilder result = new( s[0..2], s.Length );
