 ...
 *   and check if the current value of original is in the array.
 *
 * Hint 2:
...
public class KeepMultiplyingFoundValuesByTwo
{
    public int FindFinalValue( int[] nums, int original )
    {
        ...
        while ( original <= 1000 && map[original] )
        {
            original <<= 1;
        }
