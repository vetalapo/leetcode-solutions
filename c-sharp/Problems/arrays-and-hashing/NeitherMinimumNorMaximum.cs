 ...
 * find and return any number from the array that is
 * neither the minimum nor the maximum value in the array,
 ...
 *   Output: -1
 *   Explanation:
 *     Since there is no number in nums that is
 *     neither the maximum nor the minimum,
 *     we cannot select a number that satisfies the given condition.
 ...
 *   Output: 2
 *   Explanation:
 *     Since 2 is neither the maximum nor the minimum value in nums,
