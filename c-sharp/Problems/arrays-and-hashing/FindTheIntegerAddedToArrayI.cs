 ...
 *   • The test cases are generated in a way
 *     that there is an integer x such that
 *     nums1 can become equal to nums2
 *     by adding x to each element of nums1.
 *
 * Hint 1:
 *   Notice that, after sorting both arrays,
 *   there should be a one-to-one correspondence between every element.
 *
 * Hint 2:
