 ...
 **
 * The letter value of a letter is
 * its position in the alphabet starting from 0
 * (i.e. 'a' -> 0, 'b' -> 1, 'c' -> 2, etc.).
 *
 ...
 *
 * Return true
 * if the summation of the numerical values of firstWord and secondWord equals
 * the numerical value of targetWord,
 * or false otherwise.
 *
 * Example 1:
