 ...
 * if each element is greater than or equal to its previous element
 * (if it exists).
 *
 * Example 1:
 *   Input: nums = [5,2,3,1]
 *   Output: 2
 *   Explanation:
 *     The pair (3,1) has the minimum sum of 4.
 *     After replacement, nums = [5,2,4].
 *     The pair (2,4) has the minimum sum of 6.
 *     After replacement, nums = [5,6].
