 ...
 * that appears exactly once in nums.
 ...
 *   Output: 2
 *   Explanation:
 *     Both 2 and 6 are even and they appear exactly once.
 *     Since 2 occurs first in the array, the answer is 2.
 *
 * Example 2:
 *   Input: nums = [4,4]
 *   Output: -1
