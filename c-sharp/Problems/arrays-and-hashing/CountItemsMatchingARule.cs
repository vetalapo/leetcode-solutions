 ...
 *   Output: 1
 *   Explanation:
 *     There is only one item matching the given rule,
 ...
 *   and check if each one matches the rule according to the statement.
 **
...
public class CountItemsMatchingARule
{
    public int CountMatches( IList<IList<string>> items, string ruleKey, string ruleValue )
    {
        ...
        return items.Count( item => item[ruleId] == ruleValue );
    }
}
