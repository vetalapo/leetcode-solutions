 ...
 *   Output: false
 *   Explanation:
 *     There is no way to divide nums into 4 / 2 = 2 pairs
 ...
 *
 * Hint 2:
 *   The elements with equal value can be divided completely into pairs
 *   if and only if their count is even.
 **
