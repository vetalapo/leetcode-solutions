 ...
 * find the 0-indexed position of the row
 * that contains the maximum count of ones,
 * and the number of ones in that row.
 * In case there are multiple rows
 * that have the maximum count of ones,
 ...
 *     So we return the index of the smaller row, 0,
 *     and the maximum count of ones (1).
 ...
 *     So we return its index, 1, and the count.
