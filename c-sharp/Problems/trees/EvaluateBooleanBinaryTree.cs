 ...
 **
 * You are given the root of a full binary tree
 ...
 *     the evaluation is the value of the node,
 *     i.e. True or False.
 *   • Otherwise,
 *     evaluate the node's two children
 *     and apply the boolean operation
 ...
 *   Output: false
 *   Explanation:
 *     The root node is a leaf node and it evaluates to false,
 *     so we return false.
 *
 * Constraints:
