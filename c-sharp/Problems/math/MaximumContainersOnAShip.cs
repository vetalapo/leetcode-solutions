 ...
 *   Output: 4
 *   Explanation:
 *     The deck has 4 cells,
 *     and each container weighs 3.
 *     The total weight of loading all containers is 12,
 ...
 *     without exceeding maxWeight is 4.
 *
 * Constraints:
 *   • 1 <= n <= 1000
 *   • 1 <= w <= 1000
