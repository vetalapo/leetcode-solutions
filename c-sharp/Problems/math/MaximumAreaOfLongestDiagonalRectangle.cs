 ...
 * dimensions[i][0] represents the length
 ...
 *     So,the rectangle at index 1
 *     has a greater diagonal length
 *     therefore we return area = 8 * 6 = 48.
 *
 * Example 2:
 *   Input: dimensions = [[3,4],[4,3]]
 *   Output: 12
 *   Explanation:
 *     Length of diagonal is the same for both which is 5,
 *     so maximum area = 12.
 *
 * Constraints:
...
public class MaximumAreaOfLongestDiagonalRectangle
{
    public int AreaOfMaxDiagonal( int[][] dimensions )
    {
        ...
        {
            int currDiagonalSq = rect[0] * rect[0] + rect[1] * rect[1];
