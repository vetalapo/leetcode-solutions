 ...
 *   1. Convert s into an integer by replacing each letter
 ...
 * Hint 1:
 *   First,
 *   let's note that after the first transform
 *   the value will be at most 100 * 10 which is not much
 *
 * Hint 2:
 *   After The first transform,
 *   we can just do the rest of the transforms by brute force
 **
