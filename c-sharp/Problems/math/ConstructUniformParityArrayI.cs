 ...
 *
 * You want to construct another array *nums2 of length n
 * such that the elements in nums2 are either all odd or all even.
 *
 * For each index i,
 * you must choose exactly one of the following (in any order):
 *   • nums2[i] = nums1[i]
...
{
    public bool UniformArray( int[] _ )
    {
        return true;
    }
}
