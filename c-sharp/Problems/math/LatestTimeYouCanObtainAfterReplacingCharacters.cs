 ...
 * where HH is between 00 and 11,
 * and MM is between 00 and 59.
 * The earliest 12-hour time is 00:00,
 * and the latest is 11:59.
 *
 * You have to replace all the "?" characters in s
 * with digits such that the time we obtain
 * by the resulting string is a valid 12-hour format time
 ...
 *   Output: "11:54"
 *   Explanation:
 *     The latest 12-hour format time
 *     we can achieve by replacing "?" characters is "11:54".
 *
 * Example 2:
 *   Input: s = "0?:5?"
 *   Output: "09:59"
 *   Explanation:
 *     The latest 12-hour format time
 *     we can achieve by replacing "?" characters is "09:59".
 *
 * Constraints:
 *   • s.length == 5
 ...
 *     that there is at least one time between "00:00" and "11:59"
 ...
 *   that can be generated from the string
