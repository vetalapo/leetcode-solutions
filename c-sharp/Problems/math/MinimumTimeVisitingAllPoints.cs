 ...
 *       (in other words, move one unit vertically then one unit horizontally in 1 second).
 *   • You have to visit the points in the same order
 *     as they appear in the array.
 *   • You are allowed to pass through points
 *     that appear later in the order,
 ...
 *   there will be an optimal strategy to walk?
 *
 * Hint 2:
 *   Advance in diagonal as possible
 *   then after that go in straight line.
 *
 * Hint 3:
...
public class MinimumTimeVisitingAllPoints
{
    ...
    {
        // Solution based on Chebyshev distance
        int sum = 0;
