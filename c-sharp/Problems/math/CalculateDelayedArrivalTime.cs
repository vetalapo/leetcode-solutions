 ...
 * denoting the arrival time of a train in hours,
 * and another positive integer delayedTime
 ...
 *
 * Hint 1:
 *   Use the modulo operator to handle the case
 *   when the arrival time plus the delayed time
 *   goes beyond 24 hours.
 *
 * Hint 2:
 *   If the arrival time plus the delayed time is greater than or equal to 24,
 *   you can also subtract 24 to get the time in the 24-hour format.
 **
