 ...
 * Every second,
 * the person holding the pillow passes it to the next person standing in the line.
 * Once the pillow reaches the end of the line,
 * the direction changes,
 * and people continue passing the pillow in the opposite direction.
 *
 * For example,
 * once the pillow reaches the nth person they pass it to the n - 1th person,
 ...
 *     1 -> 2 -> 3 -> 4 -> 3 -> 2.
 *     After five seconds,
 *     the 2nd person is holding the pillow.
 *
 * Example 2:
 *   Input: n = 3, time = 2
 *   Output: 3
 ...
 *     1 -> 2 -> 3.
 *     After two seconds,
 *     the 3rd person is holding the pillow.
 *
 * Constraints:
 *   • 2 <= n <= 1000
 *   • 1 <= time <= 1000
 ...
 *
 * Hint 1:
 *   Maintain two integer variables,
 *   direction and i,
 ...
 *
 * Hint 2:
 *   While time is positive,
 *   update the current index with the current direction.
 *   If the index reaches the end of the line,
